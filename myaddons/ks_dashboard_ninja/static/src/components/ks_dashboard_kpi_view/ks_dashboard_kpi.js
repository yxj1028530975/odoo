...
//                context: self.getContext(),
    ...
    _update_view(){
        ...
        $('#' + this.item.id).find('.ks_dashboarditem_id').css({
    ...
    get kpitemplate(){
        if (!this.kpi_data[1]) {
            if (this.field.ks_target_view === "Number" || !this.field.ks_goal_enable) {
                return 'ks_kpi_template'
            }
            else if (this.field.ks_target_view === "Progress Bar" && this.field.ks_goal_enable) {
                return 'ks_kpi_template_3'
            }
            else{
                return 'ks_kpi_dummy'
            }
